        ...
        if(closest){
            ...
            if(_nCT==='egg'){
                ...
                if(cd2<2.5&&egg.onGround&&Math.random()<0.024&&!egg._npcShoryuActive&&(!egg._npcSpecialCD||egg._npcSpecialCD<=0)){
                    ...
                    MoveUppercut_execute(egg,Math.atan2(cdx2,cdz2),{duration:MOVE_PARAMS.blossomTraveler.shoryuken.duration,jumpMul:1.5,fwdSpeed:MOVE_PARAMS.blossomTraveler.shoryuken.fwdSpeed});
                    _shoutMove(egg,MOVE_PARAMS.blossomTraveler.shoryuken);
                ...
                if(cd2>2&&cd2<8&&egg.onGround&&Math.random()<0.024&&!egg._npcTatsuActive&&(!egg._npcSpecialCD||egg._npcSpecialCD<=0)){
                    ...
                    _shoutMove(egg,MOVE_PARAMS.blossomTraveler.tatsumaki);
                }
            }
            ...
            // Herb Traveler (legacy bull type): leaf flurry, forest sway
            else if(_nCT==='bull'){
                if(cd2<2.5&&Math.random()<0.06&&(!egg._npcSpecialCD||egg._npcSpecialCD<=0)){
                    egg._npcSpecialCD=30;_shoutMove(egg,MOVE_PARAMS.herbTraveler.hyakuretsu);
                ...
                if(cd2>3&&cd2<10&&egg.onGround&&Math.random()<0.024&&(!egg._npcSpecialCD||egg._npcSpecialCD<=0)){
                    ...
                    MoveDash_execute(egg,_nhbDir,{isDash:true,speed:2,duration:40});_shoutMove(egg,MOVE_PARAMS.herbTraveler.headbutt);
