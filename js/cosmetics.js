...
function _openShop(){
    ...
    card.innerHTML=
        '<div class="shop-header">'+
          '<div class="shop-brand"><div class="shop-brand-mark">\u2726</div><div><div class="shop-title">'+_shopLocalizedName()+'</div><div class="shop-subtitle">TRAVELER BOUTIQUE \u00B7 \u539F\u521B\u5916\u89C2\u6536\u85CF</div></div></div>'+
...
function _shopLocalizedName(){
    ...
    }[_langCode]||'Traveler\'s General Store';
}
function _shopLocalizedEnterDesc(){
    ...
    }[_langCode]||'Enter the Traveler\'s General Store?';
}
