...
// Default entry points for a new character session. City IDs remain stable;
// display-name changes never affect map loading, portals or existing saves.
var CITY_DEFAULT_SPAWNS=[
    {x:0,y:15,z:0},    // City of Hope
    {x:0,y:15,z:0},    // Golden Harvest Fields
    {x:0,y:15,z:0},    // Salt Crystal Tundra
    {x:0,y:15,z:0},    // Lava Canyon
    {x:0,y:15,z:0},    // Fragrant Fruit Town
    {x:50,y:0.5,z:0},  // Lunaglow City
    {x:0,y:14,z:-30},  // Cherry Blossom Valley
    {x:0,y:6,z:0}      // Silver Snow Village
];
...
var RENDER_CONFIG={
    ...
    environmentIntensity:0.82, lowEnvironmentIntensity:0.90, backgroundIntensity:0.85,
    sunColor:0xFFD9A0, sunIntensity:4.5, lowSunIntensity:5.2,
    ...
    toneExposure:0.58, lowToneExposure:0.66
};
...
// ---- Travel-beacon parameters (stable data key retained) ----
var PIPE_CONFIG={
    radius:3, height:8,
