...
// Cute pastel, storybook-like, kid-friendly navigation. No realistic/military look.
// Reads existing globals (playerEgg, cityNPCs, cityCoins, cityChests, portals,
// travel-beacon mesh data, currentCityStyle, CITY_STYLES, gameState) — no extra wiring needed.
...
function _updateMiniMapLegacy(){
    ...
    // travel beacons (🚪) and race portals (🏁)
...
function _worldNodeName(node){
    if(node.style==='cloud'){var _cn={zhs:'\u2601\uFE0F 云之岛',zht:'\u2601\uFE0F 雲之島',ja:'\u2601\uFE0F 雲の島',en:'\u2601\uFE0F Cloud Island'};return _cn[_langCode]||_cn.en;}
...
function _worldMapCopy(){
    var all={
        zhs:{eyebrow:'世界地图 · 冒险图鉴',title:'世界地图 · 冒险图鉴',here:'当前位置',progress:'探索进度',visited:'已打卡',current:'当前位置',locked:'未到达',hint:'按 M 键或点击空白区域关闭'},
        zht:{eyebrow:'世界地圖 · 冒險圖鑑',title:'世界地圖 · 冒險圖鑑',here:'目前位置',progress:'探索進度',visited:'已打卡',current:'目前位置',locked:'未到達',hint:'按 M 鍵或點擊空白區域關閉'},
        ja:{eyebrow:'ワールドマップ · アドベンチャーガイド',title:'ワールドマップ · アドベンチャーガイド',here:'現在地',progress:'探索進捗',visited:'チェック済み',current:'現在地',locked:'未到達',hint:'Mキーまたは外側をクリックして閉じる'},
        en:{eyebrow:'WORLD MAP · ADVENTURE GUIDE',title:'WORLD MAP · ADVENTURE GUIDE',here:'Current location',progress:'Exploration',visited:'Checked in',current:'You are here',locked:'Undiscovered',hint:'Press M or click outside to close'}
    };
