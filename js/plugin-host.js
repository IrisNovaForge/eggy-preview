(function(){
    ...
    function selectedCharacterSnapshot(){
        ...
        var legacyKey=ch.name||rosterCharacter.type||('char'+idx);
        var key=rosterCharacter.id||ch.id||legacyKey;
        var canonicalKey=rosterCharacter.canonicalId||ch.canonicalId||key;
        var localizedName=
        ...
        var snap={
            ...
            legacyId:legacyKey,
            legacyCharacterId:rosterCharacter.legacyId||ch.legacyId||key,
            aliases:[canonicalKey,rosterCharacter.legacyId,ch.legacyId,legacyKey].concat(rosterCharacter.aliases||[]).filter(function(value,index,array){
