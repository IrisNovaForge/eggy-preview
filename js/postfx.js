...
function _initCinematicPostFX(){
    ...
    _postFXBloom=new UnrealBloomPass(new THREE.Vector2(innerWidth,innerHeight),0.20,0.55,1.30);
    _postFXBloom.strength=0.20;
    ...
    if(quality==='balanced'){
        ...
        _postFXBloom.strength=0.16;
    }else if(quality==='low'){
        _postFXBloom.strength=0.10;
