...
R.toneMappingExposure=_visualQualityMode==='low'?(RENDER_CONFIG.lowToneExposure||0.66):(RENDER_CONFIG.toneExposure||0.58);
...
scene.environmentIntensity=_visualQualityMode==='low'?(RENDER_CONFIG.lowEnvironmentIntensity||0.90):(RENDER_CONFIG.environmentIntensity||0.82);
...
const sun = new THREE.DirectionalLight(RENDER_CONFIG.sunColor,_visualQualityMode==='low'?(RENDER_CONFIG.lowSunIntensity||5.2):RENDER_CONFIG.sunIntensity);
