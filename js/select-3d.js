...
(function(){
    ...
    var CHARACTER_SELECT_CITY_BY_ID={
        blossomTraveler:6,herbTraveler:7,
        saltCrystalTraveler:2,
        cloudwingTraveler:0,fruitbrewTraveler:4,
        berryTraveler:5,spicyFlameTraveler:3,
        goldenGrainTraveler:1
    };
    var CHARACTER_SELECT_CITY_MAP=CHARACTERS.map(function(character,index){
        var mapped=Number.isInteger(character.birthCity)?character.birthCity:CHARACTER_SELECT_CITY_BY_ID[character.id];
    ...
    function makeStage(ch,index){
        ...
        try{model=createEggMesh(ch.color,ch.accent,ch.id);}
        ...
        (model.userData._saltCrystalEars||[]).forEach(markCaster);
        ...
        (model.userData._spiceDetails||[]).forEach(markCaster);
    ...
    var cardGestureKindsById={
        ...
        saltCrystalTraveler:'salt-crystal-skip',
        cloudwingTraveler:'cloudwing-float',
        fruitbrewTraveler:'fruitbrew-bounce',
        berryTraveler:'berry-hop',
        spicyFlameTraveler:'spicy-flame-nod',
        goldenGrainTraveler:'golden-grain-sway'
    };
    var cardGestureKinds=CHARACTERS.map(function(character){return cardGestureKindsById[character.id]||'gentle-wave';});
    ...
    function setSelected(idx){
        ...
        var archetype=document.getElementById('select-archetype'),desc=document.getElementById('select-hero-desc'),count=document.getElementById('select-roster-index'),name=document.getElementById('traveler-char-name');
    ...
    function renderRect(el,item,hero,t){
        ...
        if(gestureActive){
            ...
            var detailLists=[
                ud._flowerDetails||[],ud._forestLeaves||[],ud._saltCrystalSparkles||[],ud._cloudwingDetails||[],
                ud._fruitbrewDetails||[],ud._berryDetails||[],ud._spiceDetails||[],ud._goldenGrainDetails||[]
            ];
