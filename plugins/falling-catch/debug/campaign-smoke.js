(function(){
    ...
    try{
        ...
        assert(levels[0].targetCatchBox.mode==='center'&&levels[0].targetCatchBox.halfWidth===2&&levels[0].targetCatchBox.topOffset===-2.8&&levels[0].targetCatchBox.bottomOffset===-.8,'Stage 1 uses the airflow-zone-sized center-entry catch box');
        ...
        assert(levels[1].targetCatchBox===levels[0].targetCatchBox&&levels[1].basketOffsetY===-17.5,'Stage 2 keeps the same overhead airflow catch zone and center-entry catch box');
        ...
        assert(levels[3].status==='playable'&&levels[3].mechanics==='confluence'&&levels[3].basketOffsetY===-17.5&&levels[3].targetCatchBox===levels[0].targetCatchBox,'Stage 4 enables confluence with the shared overhead airflow catch box');
