(function(){
    ...
    function eggPath(context){
        context.beginPath();context.moveTo(0,-13.25);context.bezierCurveTo(-3.75,-13.1,-5.55,-8.65,-5.15,-4.55);context.bezierCurveTo(-4.8,-.75,-2.65,.25,0,.25);context.bezierCurveTo(2.65,.25,4.8,-.75,5.15,-4.55);context.bezierCurveTo(5.55,-8.65,3.75,-13.1,0,-13.25);context.closePath();
    }
    ...
    function drawArm(context,side,hand,state,colors){
        ...
        context.lineCap='round';context.lineJoin='round';context.strokeStyle='#42675b';context.lineWidth=2.45;context.beginPath();context.moveTo(shoulderX,shoulderY);context.quadraticCurveTo(elbowX,elbowY,hand.x,hand.y);context.stroke();
        context.strokeStyle=colors.body;context.lineWidth=1.75;context.stroke();context.fillStyle=colors.body;ellipse(context,hand.x,hand.y,.92,.82,0);
    }
    function drawFeet(context,state,colors){
        ...
        context.strokeStyle='#42675b';context.lineWidth=.72;context.fillStyle=colors.accent;
        context.beginPath();context.ellipse(-2.6+stride,-.05-leftLift,1.75,.72,-.08,0,Math.PI*2);context.fill();context.stroke();
        context.beginPath();context.ellipse(2.6+stride,-.05-rightLift,1.75,.72,.08,0,Math.PI*2);context.fill();context.stroke();
    }
    function drawFace(context){
        ...
        context.strokeStyle='#35594f';context.lineWidth=.5;context.lineCap='round';context.beginPath();context.arc(0,-6.62,1.05,.16,Math.PI-.16);context.stroke();
    ...
    function drawTopper(context,view,state){
        ...
        context.save();context.translate(sway,0);context.strokeStyle='#42675b';context.lineWidth=.42;context.lineCap='round';context.lineJoin='round';context.fillStyle=accent;
        if(view.topper==='blossom'){
            ...
            context.beginPath();context.moveTo(0,-15.45);context.lineTo(1.65,-13.7);context.lineTo(.65,-12.85);context.lineTo(-1.35,-13.25);context.lineTo(-1.6,-14.45);context.closePath();context.fill();context.stroke();context.strokeStyle='rgba(255,255,255,.7)';context.beginPath();context.moveTo(0,-15.05);context.lineTo(.35,-13.35);context.stroke();
            ...
            context.strokeStyle='#9a7637';context.lineWidth=.52;context.beginPath();context.moveTo(0,-12.9);context.lineTo(0,-15.4);context.stroke();context.fillStyle=accent;ellipse(context,-.85,-14.85,.75,.42,-.5);ellipse(context,.82,-14.15,.75,.42,.48);ellipse(context,-.78,-13.55,.7,.4,-.45);
        }
        context.restore();
    }
    function draw(context,view,state){
        ...
        context.fillStyle=view.body;context.strokeStyle='#42675b';context.lineWidth=.58;eggPath(context);context.fill();context.stroke();
        context.save();eggPath(context);context.clip();var shade=context.createLinearGradient(-4,-12,4,0);shade.addColorStop(0,'rgba(255,255,255,.62)');shade.addColorStop(.48,'rgba(255,255,255,.04)');shade.addColorStop(1,'rgba(42,88,72,.16)');context.fillStyle=shade;context.fillRect(-6,-14,12,15);context.restore();
        context.fillStyle='rgba(255,255,255,.5)';ellipse(context,-2.15,-10.7,1.15,2.05,.28);drawFace(context);drawTopper(context,view,state);
    }
