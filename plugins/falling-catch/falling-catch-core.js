(function(){
    ...
    var COPY={
        zhs:{
            title:'风中取物',eyebrow:'',intro:'用头顶采集篮接住青风嫩叶、莓霞花瓣和金穗种子，同时避开黯化硬壳。',
        ...
        zht:{
            title:'風中取物',eyebrow:'',intro:'用頭頂採集籃接住青風嫩葉、莓霞花瓣和金穗種子，同時避開黯化硬殼。',
        ...
        ja:{
            title:'風の中でキャッチ',eyebrow:'',intro:'頭上の採集かごで青風の若葉・莓霞の花びら・金穂の種を集め、くすみ硬殻をよけよう。',
        ...
        en:{
            title:'Catching in the Wind',eyebrow:'',intro:'Catch Breezeleaves, Berryglow Petals and Goldengrain Seeds in the overhead basket, and avoid dull hardened shells.',
    ...
    function create(options){
        ...
        var portraitUrl=portraitValue&&portraitValue.src?portraitValue.src:(typeof portraitValue==='string'?portraitValue:assetBase+'assets/travelers/'+traveler.file+'?v=0.4.25');
